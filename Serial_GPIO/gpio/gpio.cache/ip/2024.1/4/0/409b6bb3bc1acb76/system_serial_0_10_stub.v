...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(wr_request, rd_request, 
  clear_overflow_request, wr_data, rd_data, empty, full, baudClockOut, tx_out, rx_in, overflow, 
  wr_index, rd_index, watermark, enableing, testing, txBaud, baudTick, TXGo, TXIdle, frameError, 
  parityError, axi_aclk, axi_aresetn, axi_awaddr, axi_awprot, axi_awvalid, axi_awready, 
...
/* synthesis syn_black_box black_box_pad_pin="wr_request,rd_request,clear_overflow_request,wr_data[8:0],rd_data[8:0],empty,full,baudClockOut,tx_out,rx_in,overflow,wr_index[4:0],rd_index[4:0],watermark[4:0],enableing,testing,txBaud,baudTick,TXGo,TXIdle,frameError,parityError,axi_aresetn,axi_awaddr[3:0],axi_awprot[2:0],axi_awvalid,axi_awready,axi_wdata[31:0],axi_wstrb[3:0],axi_wvalid,axi_wready,axi_bresp[1:0],axi_bvalid,axi_bready,axi_araddr[3:0],axi_arprot[2:0],axi_arvalid,axi_arready,axi_rdata[31:0],axi_rresp[1:0],axi_rvalid,axi_rready" */
