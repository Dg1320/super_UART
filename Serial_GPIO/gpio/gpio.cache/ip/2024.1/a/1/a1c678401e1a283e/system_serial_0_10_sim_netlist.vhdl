...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my9x16Fifo is
  port (
    ...
    sendRxInterrupt_reg : out STD_LOGIC;
    clear : out STD_LOGIC;
...
sendRxInterrupt_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"000000008ABA0000"
    )
        port map (
      I0 => rx_intr,
      I1 => \axi_rdata_reg[12]\(7),
      I2 => \axi_rdata_reg[12]\(4),
      I3 => \^debugsignals\(6),
      I4 => axi_aresetn,
      I5 => \axi_rdata_reg[12]\(6),
      O => sendRxInterrupt_reg
    );
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my9x16Fifo_0 is
  port (
    ...
    sendTxInterrupt_reg : out STD_LOGIC;
    p_13_in : out STD_LOGIC;
...
sendTxInterrupt_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000000AABAAA8A"
    )
        port map (
      I0 => tx_intr,
      I1 => \axi_rdata_reg[20]\(4),
      I2 => \axi_rdata_reg[20]\(3),
      I3 => \axi_rdata_reg[20]\(2),
      I4 => \^debugsignals\(6),
      I5 => sendTxInterrupt_reg_0,
      O => sendTxInterrupt_reg
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  signal RX_INTERRUPT_CLEAR_REQUEST : STD_LOGIC;
  signal SECOND_STOP : STD_LOGIC;
  signal TX_INTERRUPT_CLEAR_REQUEST : STD_LOGIC;
...
myTransmitter: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter
     port map (
      ...
      rd_data(8 downto 0) => \^rd_data\(8 downto 0),
      readFifoRequest => readFifoRequest,
      readFifoRequest_reg_0 => txFIFO_n_17,
      tx_out => tx_out
    );
...
rxFIFO: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my9x16Fifo
     port map (
      ...
      axi_aresetn => axi_aresetn,
      axi_arvalid => axi_arvalid,
      \axi_rdata_reg[12]\(9) => \officialControl_reg_n_0_[12]\,
      \axi_rdata_reg[12]\(8) => \officialControl_reg_n_0_[11]\,
      \axi_rdata_reg[12]\(7) => TX_INTERRUPT_CLEAR_REQUEST,
      \axi_rdata_reg[12]\(6) => RX_INTERRUPT_CLEAR_REQUEST,
      \axi_rdata_reg[12]\(5) => SECOND_STOP,
      \axi_rdata_reg[12]\(4) => INT_ON_RX,
      ...
      rx_intr => \^rx_intr\,
      sendRxInterrupt_reg => rxFIFO_n_21,
      writeFifoRequest => writeFifoRequest
    );
...
sendTxInterrupt_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"4F"
    )
        port map (
      I0 => RX_INTERRUPT_CLEAR_REQUEST,
      I1 => TX_INTERRUPT_CLEAR_REQUEST,
      I2 => axi_aresetn,
...
txFIFO: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my9x16Fifo_0
     port map (
      ...
      axi_aclk => axi_aclk,
      axi_awvalid => axi_awvalid,
      \axi_rdata_reg[20]\(9) => \officialControl_reg_n_0_[20]\,
      \axi_rdata_reg[20]\(8) => \officialControl_reg_n_0_[19]\,
      \axi_rdata_reg[20]\(7) => \officialControl_reg_n_0_[18]\,
      \axi_rdata_reg[20]\(6) => \officialControl_reg_n_0_[17]\,
      \axi_rdata_reg[20]\(5) => \officialControl_reg_n_0_[16]\,
      \axi_rdata_reg[20]\(4) => RX_INTERRUPT_CLEAR_REQUEST,
      \axi_rdata_reg[20]\(3) => INT_ON_TX,
      \axi_rdata_reg[20]\(2) => INT_ON_RX,
      \axi_rdata_reg[20]\(1) => \^q\(0),
      \axi_rdata_reg[20]\(0) => PARITY_CONTROL(3),
      ...
      p_13_in => p_13_in,
      rd_data(8 downto 0) => \^rd_data\(8 downto 0),
      sendTxInterrupt_reg => txFIFO_n_15,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute SOFT_HLUTNM of i_1478 : label is "soft_lutpair51";
  attribute SOFT_HLUTNM of i_1479 : label is "soft_lutpair52";
  attribute SOFT_HLUTNM of i_1480 : label is "soft_lutpair52";
  attribute SOFT_HLUTNM of i_1481 : label is "soft_lutpair53";
  attribute SOFT_HLUTNM of i_1482 : label is "soft_lutpair53";
  attribute SOFT_HLUTNM of i_1483 : label is "soft_lutpair54";
  attribute SOFT_HLUTNM of i_1484 : label is "soft_lutpair54";
  attribute SOFT_HLUTNM of i_1485 : label is "soft_lutpair55";
  attribute SOFT_HLUTNM of i_1486 : label is "soft_lutpair55";
  attribute SOFT_HLUTNM of i_1487 : label is "soft_lutpair56";
  attribute SOFT_HLUTNM of i_1488 : label is "soft_lutpair56";
  attribute SOFT_HLUTNM of i_1489 : label is "soft_lutpair57";
  attribute SOFT_HLUTNM of i_1490 : label is "soft_lutpair57";
  attribute SOFT_HLUTNM of i_1491 : label is "soft_lutpair58";
  attribute SOFT_HLUTNM of i_1492 : label is "soft_lutpair58";
  attribute SOFT_HLUTNM of i_1493 : label is "soft_lutpair59";
  attribute SOFT_HLUTNM of i_1494 : label is "soft_lutpair59";
  attribute SOFT_HLUTNM of i_1495 : label is "soft_lutpair60";
  attribute SOFT_HLUTNM of i_1496 : label is "soft_lutpair60";
  attribute SOFT_HLUTNM of i_1497 : label is "soft_lutpair61";
  attribute SOFT_HLUTNM of i_1498 : label is "soft_lutpair61";
  attribute SOFT_HLUTNM of i_1499 : label is "soft_lutpair62";
  attribute SOFT_HLUTNM of i_1500 : label is "soft_lutpair62";
  attribute SOFT_HLUTNM of i_1501 : label is "soft_lutpair63";
  attribute SOFT_HLUTNM of i_1502 : label is "soft_lutpair63";
  attribute SOFT_HLUTNM of i_1503 : label is "soft_lutpair64";
  attribute SOFT_HLUTNM of i_1504 : label is "soft_lutpair64";
  attribute SOFT_HLUTNM of i_1505 : label is "soft_lutpair65";
  attribute SOFT_HLUTNM of i_1506 : label is "soft_lutpair65";
  attribute SOFT_HLUTNM of i_1507 : label is "soft_lutpair66";
  attribute SOFT_HLUTNM of i_1508 : label is "soft_lutpair66";
