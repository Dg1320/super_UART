...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(wr_request, rd_request, 
  ...
  rd_index, watermark, axi_aclk, axi_aresetn, axi_awaddr, axi_awprot, axi_awvalid, axi_awready, 
...
/* synthesis syn_force_seq_prim="axi_aclk" */;
  ...
  output empty;
  output full;
  output baudClockOut /* synthesis syn_isclock = 1 */;
  output tx_out;
  output overflow;
  output [4:0]wr_index;
  output [4:0]rd_index;
