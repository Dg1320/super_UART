...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_0 is
  ...
  attribute SOFT_HLUTNM of shiftOut_i_8 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of shiftOut_i_9 : label is "soft_lutpair3";
begin
...
shiftOut_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my9x16Fifo is
  ...
  signal testIdle_i_3_n_0 : STD_LOGIC;
  ...
  signal write_request : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of empty_INST_0_i_1 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of full_INST_0 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of full_INST_0_i_1 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of myParityBit_reg_i_5 : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \rd_data[2]_INST_0\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \rd_index[1]_i_1\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of \watermark[0]_INST_0\ : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of \wr_index[0]_i_1\ : label is "soft_lutpair20";
...
\rd_data[7]_INST_0\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \rd_data[7]_INST_0_i_3_n_0\,
      I3 => \^rd_index_reg[4]_0\(2),
      I4 => \rd_data[7]_INST_0_i_4_n_0\,
      I5 => \^rd_index_reg[4]_0\(3),
      O => \^d\(6)
    );
\rd_data[7]_INST_0_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  signal \NLW_state1_inferred__1/i__carry_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  ...
  attribute SOFT_HLUTNM of myParityBit_reg_i_2 : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of myParityBit_reg_i_3 : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \raddr[3]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of shiftOut_i_3 : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of shiftOut_i_7 : label is "soft_lutpair25";
  ...
  attribute SOFT_HLUTNM of \ticks2[0]_i_1\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \ticks2[1]_i_1\ : label is "soft_lutpair29";
...
edge_detect_2: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_0
     port map (
      CO(0) => \state1_inferred__1/i__carry_n_2\,
      E(0) => edge_detect_2_n_2,
      \FSM_sequential_state_reg[0]\ => edge_detect_2_n_7,
      \FSM_sequential_state_reg[0]_0\ => \^wr_index_reg[0]\,
      \FSM_sequential_state_reg[0]_1\ => \FSM_sequential_state[0]_i_6_n_0\,
      \FSM_sequential_state_reg[0]_2\ => my9x16Fifo_inst_n_17,
      \FSM_sequential_state_reg[1]\ => \FSM_sequential_state_reg[1]_0\,
      \FSM_sequential_state_reg[1]_0\ => my9x16Fifo_inst_n_39,
      \FSM_sequential_state_reg[1]_1\ => \FSM_sequential_state[1]_i_4_n_0\,
      \FSM_sequential_state_reg[2]\ => edge_detect_2_n_5,
      \FSM_sequential_state_reg[2]_0\ => \^fsm_sequential_state_reg[2]_0\(1),
      \FSM_sequential_state_reg[2]_1\ => \FSM_sequential_state[2]_i_5_n_0\,
      Q(2) => SECOND_STOP,
      Q(1 downto 0) => PARITY_CONTROL(3 downto 2),
      axi_aclk => axi_aclk,
      axi_aresetn => axi_aresetn,
      \count_reg[0]\ => \^fsm_sequential_state_reg[2]_0\(0),
      in_delay => in_delay,
      \myParityBit__0\ => \myParityBit__0\,
      \officialControl_reg[3]\ => \officialControl_reg[3]_0\,
      outReg_reg_0 => \^outreg_reg\,
      outReg_reg_1 => edge_detect_2_n_6,
      outReg_reg_2 => outReg_reg_1,
      shiftOut_reg => shiftOut_i_7_n_0,
      \state__0\(0) => \state__0\(1),
      txBaud => \^txbaud\
    );
...
my9x16Fifo_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my9x16Fifo
     port map (
      ...
      E(0) => read_request,
      \FSM_sequential_state_reg[0]\ => my9x16Fifo_inst_n_39,
      \FSM_sequential_state_reg[0]_0\ => \^outreg_reg\,
      \FSM_sequential_state_reg[0]_1\ => \FSM_sequential_state[1]_i_4_n_0\,
      \FSM_sequential_state_reg[1]\ => \^fsm_sequential_state_reg[2]_0\(0),
      \FSM_sequential_state_reg[1]_0\ => \^fsm_sequential_state_reg[2]_0\(1),
      Q(4 downto 0) => Q(4 downto 0),
      axi_aclk => axi_aclk,
      axi_aresetn => axi_aresetn,
      ...
      officialData(8 downto 0) => officialData(8 downto 0),
      outReg_reg => my9x16Fifo_inst_n_17,
      outReg_reg_0 => outReg_reg_0,
      p_20_in => p_20_in,
...
shiftOut_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
shiftOut_reg_i_6: unisim.vcomponents.MUXF7
     port map (
      I0 => shiftOut_i_10_n_0,
      I1 => shiftOut_i_11_n_0,
...
\state1_inferred__1/i__carry\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3 downto 2) => \NLW_state1_inferred__1/i__carry_CO_UNCONNECTED\(3 downto 2),
...
outSignal_i_1: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => \^q\(0),
      I1 => keepCount0,
      I2 => serial_v1_0_AXI_inst_n_10,
      O => outSignal_i_1_n_0
    );
readFifoRequest_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFF3FFFF00010000"
    )
        port map (
...
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      ...
      D(5) => \rd_index_reg[3]\,
      D(4 downto 0) => D(4 downto 0),
      \FSM_sequential_state_reg[1]_0\ => serial_v1_0_AXI_inst_n_40,
      \FSM_sequential_state_reg[1]_1\ => serial_v1_0_AXI_inst_n_50,
      \FSM_sequential_state_reg[2]_0\(1) => \state__0\(2),
      \FSM_sequential_state_reg[2]_0\(0) => \state__0\(0),
      Q(4 downto 0) => \wr_index_reg[4]\(4 downto 0),
      TXGo => TXGo,
      TXIdle => \^txidle\,
      aw_en_reg_0 => serial_v1_0_AXI_inst_n_12,
      ...
      tx_out => \^tx_out\,
      watermark(4 downto 0) => watermark(4 downto 0),
      \wr_index_reg[0]\ => serial_v1_0_AXI_inst_n_35
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal n_0_449 : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of i_434 : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of i_435 : label is "soft_lutpair31";
  ...
  attribute SOFT_HLUTNM of i_439 : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of i_440 : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of i_441 : label is "soft_lutpair34";
  attribute SOFT_HLUTNM of i_442 : label is "soft_lutpair34";
  attribute SOFT_HLUTNM of i_443 : label is "soft_lutpair35";
  attribute SOFT_HLUTNM of i_444 : label is "soft_lutpair35";
  attribute SOFT_HLUTNM of i_445 : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of i_447 : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of i_448 : label is "soft_lutpair37";
  attribute SOFT_HLUTNM of i_449 : label is "soft_lutpair37";
  attribute SOFT_HLUTNM of \inst/serial_v1_0_AXI_inst/i_/i_/i_\ : label is "soft_lutpair30";
