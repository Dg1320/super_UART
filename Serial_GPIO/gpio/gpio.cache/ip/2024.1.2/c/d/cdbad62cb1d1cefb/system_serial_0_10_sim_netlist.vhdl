...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detectread is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detectread;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detectread is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detectwrite is
  port (
    wr : out STD_LOGIC;
    SR : out STD_LOGIC_VECTOR ( 0 to 0 );
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detectwrite;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detectwrite is
  signal in_delay : STD_LOGIC;
...
rd_edge: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detectread
     port map (
      E(0) => E(0),
      SR(0) => rd_edge_n_1,
      axi_aclk => axi_aclk,
...
wr_edge: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detectwrite
     port map (
