...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my9x16Fifo is
  ...
  signal \^rd_index_reg[3]_4\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of myParityBit_reg_i_4 : label is "soft_lutpair10";
...
begin
  ...
  \rd_index_reg[3]_4\ <= \^rd_index_reg[3]_4\;
...
myParityBit_reg_i_4: unisim.vcomponents.LUT5
    generic map(
      INIT => X"69969669"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_state[12]_i_3\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \FSM_onehot_state[12]_i_6\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of myParityBit_reg_i_2 : label is "soft_lutpair17";
...
\FSM_onehot_state[12]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0202C202"
    )
        port map (
...
\FSM_onehot_state[12]_i_8\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
shiftOut_i_6: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AA8A"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial is
  ...
  signal serial_v1_0_AXI_inst_n_27 : STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of i_458 : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of i_459 : label is "soft_lutpair24";
  ...
  attribute SOFT_HLUTNM of i_471 : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of i_472 : label is "soft_lutpair30";
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial
     port map (
      ...
      empty => empty,
      full => full,
      rd_data(3 downto 2) => rd_data(8 downto 7),
      rd_data(1 downto 0) => rd_data(2 downto 1),
