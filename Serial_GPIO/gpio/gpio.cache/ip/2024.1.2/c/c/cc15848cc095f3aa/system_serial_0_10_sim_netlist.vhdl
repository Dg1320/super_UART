...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  signal \officialControl_reg_n_0_[4]\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of baudClockOut_INST_0 : label is "soft_lutpair91";
  ...
  attribute SOFT_HLUTNM of outSignal_i_2 : label is "soft_lutpair91";
...
myFifo: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_FIFOTEST
     port map (
      ...
      \axi_rdata_reg[8]_1\(5) => p_0_in7_in,
      \axi_rdata_reg[8]_1\(4) => \officialControl_reg_n_0_[4]\,
...
outSignal_i_2: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
