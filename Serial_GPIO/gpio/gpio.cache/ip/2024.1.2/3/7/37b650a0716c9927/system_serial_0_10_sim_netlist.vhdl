...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect is
  ...
  attribute SOFT_HLUTNM of in_delay_i_1 : label is "soft_lutpair0";
begin
...
overflow_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"2222222300000003"
    )
        port map (
      I0 => axi_aresetn,
      I1 => clear_overflow_request,
      I2 => overflow_reg,
      I3 => \FIFO_DATA[1][8]_i_3_n_0\,
      I4 => overflow_reg_0,
      I5 => overflow,
      O => axi_aresetn_0
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_FIFOTEST is
  ...
  attribute SOFT_HLUTNM of overflow_i_3 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \wr_index[0]_i_1\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \wr_index[4]_i_5\ : label is "soft_lutpair2";
begin
...
wr_edge: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect
     port map (
      ...
      overflow_reg_0 => overflow_i_3_n_0,
      \wr_index_reg[0]\ => wr_edge_n_9,
      \wr_index_reg[0]_0\ => \^axi_wready_reg\,
      \wr_index_reg[0]_1\ => \wr_index[4]_i_5_n_0\
    );
...
\wr_index[4]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFD"
    )
        port map (
