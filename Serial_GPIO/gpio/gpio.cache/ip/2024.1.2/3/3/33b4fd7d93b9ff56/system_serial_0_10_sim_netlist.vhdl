...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_0 is
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_txState[2]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \FSM_sequential_txState[2]_i_4\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \count[3]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \count[3]_i_4\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of readFifoRequest_i_2 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of shiftOut_i_12 : label is "soft_lutpair1";
begin
...
\FSM_sequential_txState[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \^outreg_reg_0\,
      I3 => \FSM_sequential_txState_reg[0]_1\,
...
\FSM_sequential_txState[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \FSM_sequential_txState_reg[1]_0\,
...
\FSM_sequential_txState[2]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"33F8000833FB0008"
    )
        port map (
      I0 => \FSM_sequential_txState[2]_i_4_n_0\,
      I1 => \count_reg[0]_0\,
      I2 => \count_reg[0]\,
      I3 => \FSM_sequential_txState_reg[2]\,
      I4 => \^outreg_reg_0\,
      I5 => \FSM_sequential_txState_reg[1]_0\,
...
shiftOut_i_12: unisim.vcomponents.LUT5
    generic map(
      INIT => X"30700030"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_parityLogic is
  port (
    ...
    shiftOut_reg_1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    shiftOut_reg_2 : in STD_LOGIC;
    shiftOut_i_3_0 : in STD_LOGIC;
...
myParityBit_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"23DFDC20"
        ...
        port map (
      I0 => Q(6),
      I1 => myParityBit_reg_1(0),
      I2 => myParityBit_reg_1(1),
      I3 => Q(5),
      I4 => myParityBit_i_3_n_0,
      O => \officialControl_reg[0]\
    );
myParityBit_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"96696996"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my9x16Fifo is
  ...
  signal write_request : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of empty_INST_0_i_1 : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of full_INST_0 : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of full_INST_0_i_1 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \rd_index[1]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \rd_index[2]_i_1\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \watermark[0]_INST_0\ : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of \wr_index[0]_i_1\ : label is "soft_lutpair18";
...
\FSM_sequential_txState[0]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0037111100000000"
    )
        port map (
      I0 => \^wr_index_reg[0]_0\,
      I1 => \FSM_sequential_txState_reg[0]\,
      I2 => \axi_rdata_reg[8]\(8),
      I3 => \FSM_sequential_txState_reg[0]_0\,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  signal my9x16Fifo_inst_n_21 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_txState[0]_i_4\ : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of shiftOut_i_11 : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of \ticks2[0]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \ticks2[1]_i_1\ : label is "soft_lutpair24";
...
\count[3]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \count__0\(1),
      I4 => \^txstate__0\(1),
      I5 => \^fsm_sequential_txstate_reg[0]_0\,
      O => \count[3]_i_2_n_0\
    );
...
edge_detect_2: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_0
     port map (
      ...
      \FSM_sequential_txState_reg[0]\ => \FSM_sequential_txState[0]_i_3_n_0\,
      \FSM_sequential_txState_reg[0]_0\ => my9x16Fifo_inst_n_17,
      \FSM_sequential_txState_reg[0]_1\ => \FSM_sequential_txState[0]_i_4_n_0\,
      \FSM_sequential_txState_reg[1]\ => edge_detect_2_n_6,
      \FSM_sequential_txState_reg[1]_0\ => \^wr_index_reg[0]\,
      \FSM_sequential_txState_reg[1]_1\ => \^fsm_sequential_txstate_reg[0]_0\,
      ...
      \count_reg[0]_0\ => \^txstate__0\(1),
      in_delay => in_delay,
      in_delay_reg_0 => \^sixteenxslower_reg_0\,
      \officialControl_reg[8]\ => edge_detect_2_n_5,
...
my9x16Fifo_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my9x16Fifo
     port map (
      D(8) => my9x16Fifo_inst_n_20,
      D(7) => my9x16Fifo_inst_n_21,
      D(6) => my9x16Fifo_inst_n_22,
      D(5) => my9x16Fifo_inst_n_23,
      D(4) => my9x16Fifo_inst_n_24,
      D(3) => my9x16Fifo_inst_n_25,
      D(2) => my9x16Fifo_inst_n_26,
      D(1) => my9x16Fifo_inst_n_27,
      D(0) => my9x16Fifo_inst_n_28,
      E(0) => read_request,
      \FSM_sequential_txState_reg[0]\ => \^txstate__0\(1),
      \FSM_sequential_txState_reg[0]_0\ => \^txstate__0\(2),
      \FSM_sequential_txState_reg[0]_1\ => \^txstate__0\(0),
      \FSM_sequential_txState_reg[0]_2\ => \^outreg_reg\,
      \FSM_sequential_txState_reg[1]\ => my9x16Fifo_inst_n_17,
      Q(4 downto 0) => Q(4 downto 0),
      axi_aclk => axi_aclk,
      axi_aresetn => axi_aresetn,
...
shiftOut_i_11: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
...
txParityLogic: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_parityLogic
     port map (
      ...
      Q(7) => latchData(8),
      Q(6 downto 0) => latchData(6 downto 0),
      axi_aclk => axi_aclk,
      myParityBit => myParityBit,
      ...
      shiftOut_i_3_0 => \^outreg_reg\,
      shiftOut_reg => \^txstate__0\(1),
      shiftOut_reg_0 => \^txstate__0\(0),
      shiftOut_reg_1(0) => \count__0\(3),
      shiftOut_reg_2 => shiftOut_reg_i_6_n_0
    );
...
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      ...
      \officialControl_reg[0]_0\ => serial_v1_0_AXI_inst_n_47,
      \officialControl_reg[5]_0\(3 downto 2) => \^q\(1 downto 0),
      \officialControl_reg[5]_0\(1 downto 0) => PARITY_CONTROL(3 downto 2),
      outReg_reg => \^outreg_reg\,
      outReg_reg_0 => serial_v1_0_AXI_inst_n_40,
      outReg_reg_1 => \outReg_i_1__0_n_0\,
      outReg_reg_2 => outReg_i_1_n_0,
      ...
      tx_out => \^tx_out\,
      watermark(4 downto 0) => watermark(4 downto 0),
      \wr_index_reg[0]\ => serial_v1_0_AXI_inst_n_44
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal n_0_423 : STD_LOGIC;
  signal n_0_424 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of i_423 : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of i_424 : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of i_425 : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of i_426 : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of i_427 : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of i_428 : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of i_429 : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of i_430 : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of i_431 : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of i_432 : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of i_433 : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of i_434 : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of i_436 : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of i_437 : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of i_438 : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of \inst/serial_v1_0_AXI_inst/i_/i_/i_\ : label is "soft_lutpair25";
