...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_0 is
  port (
    ...
    \FSM_sequential_txState_reg[1]_0\ : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_0 is
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_txState[1]_i_4\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \FSM_sequential_txState[2]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \FSM_sequential_txState[2]_i_5\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \count[3]_i_4\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of readFifoRequest_i_2 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of readFifoRequest_i_3 : label is "soft_lutpair1";
...
\FSM_sequential_txState[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \FSM_sequential_txState_reg[0]_3\,
      I2 => \FSM_sequential_txState_reg[0]_4\,
      I3 => \^outreg_reg_0\,
...
\FSM_sequential_txState[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00F3FFFF00FB0000"
    )
        port map (
      I0 => \txState__0\(0),
      I1 => \FSM_sequential_txState[1]_i_2_n_0\,
      I2 => \FSM_sequential_txState_reg[1]_0\,
...
\FSM_sequential_txState[2]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \^outreg_reg_0\,
      I2 => CO(0),
      I3 => \FSM_sequential_txState_reg[1]_0\,
      I4 => \FSM_sequential_txState_reg[0]_1\,
      I5 => \FSM_sequential_txState_reg[0]_2\,
...
readFifoRequest_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0080"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_1 is
  port (
    ...
    \FSM_sequential_rxState_reg[2]_0\ : in STD_LOGIC;
    \FSM_sequential_rxState_reg[1]_0\ : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_1 is
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_rxState[2]_i_5\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \FSM_sequential_rxState[2]_i_6\ : label is "soft_lutpair4";
...
FE_i_2: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => \countToMySize_reg[0]_2\,
      I2 => \myRxData_reg[0]\,
      I3 => \^outreg_reg_0\,
      I4 => axi_aresetn,
      O => FE6_out
    );
\FSM_sequential_rxState[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"02FF0200"
    )
        port map (
...
\FSM_sequential_rxState[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \countToMySize_reg[0]_2\,
      I4 => Q(1),
      I5 => Q(0),
      O => \FSM_sequential_rxState[1]_i_2_n_0\
    );
\FSM_sequential_rxState[1]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"D9FF"
    )
        port map (
      I0 => \countToMySize_reg[0]_2\,
...
\FSM_sequential_rxState[2]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
        ...
        port map (
      I0 => \^e\(0),
      I1 => \latchAndDetermine_reg[1]\(3),
      I2 => \latchAndDetermine_reg[1]\(0),
      I3 => \latchAndDetermine_reg[1]\(1),
      I4 => \latchAndDetermine_reg[1]\(2),
      O => \^outreg_reg_0\
    );
\FSM_sequential_rxState[2]_i_4\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \FSM_sequential_rxState[2]_i_6_n_0\,
      I2 => \^outreg_reg_0\,
      I3 => CO(0),
...
\FSM_sequential_rxState[2]_i_6\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => \countToMySize_reg[0]_3\,
      I2 => \countToMySize_reg[0]_2\,
      I3 => rx_in,
      I4 => \^outreg_reg_0\,
      O => \FSM_sequential_rxState[2]_i_6_n_0\
    );
PE_i_3: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \latchAndDetermine_reg[1]\(0),
      I4 => \latchAndDetermine_reg[1]\(3),
      I5 => \^e\(0),
      O => axi_aresetn_1
    );
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my9x16Fifo_2 is
  port (
    ...
    axi_aclk : in STD_LOGIC;
    outReg_reg : in STD_LOGIC;
    \FSM_sequential_txState_reg[2]\ : in STD_LOGIC_VECTOR ( 2 downto 0 );
    ...
    shiftOut_reg_3 : in STD_LOGIC;
    shiftOut_reg_4 : in STD_LOGIC;
    officialData : in STD_LOGIC_VECTOR ( 8 downto 0 );
    shiftOut_i_4_0 : in STD_LOGIC;
    waddr : in STD_LOGIC_VECTOR ( 1 downto 0 );
    axi_wvalid : in STD_LOGIC;
    axi_awvalid : in STD_LOGIC;
    in_delay_reg : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my9x16Fifo_2 is
  ...
  attribute SOFT_HLUTNM of shiftOut_i_12 : label is "soft_lutpair29";
...
\FSM_sequential_txState[2]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFE000000"
        ...
        port map (
      I0 => shiftOut_i_12_n_0,
      I1 => empty_INST_0_i_2_n_0,
      I2 => empty_INST_0_i_1_n_0,
      I3 => \FSM_sequential_txState_reg[2]\(2),
...
shiftOut_i_12: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6FF6"
    )
        port map (
...
shiftOut_i_4: unisim.vcomponents.LUT6
    generic map(
      INIT => X"000000007D550000"
    )
        port map (
      I0 => shiftOut_reg,
      I1 => \FSM_sequential_txState_reg[2]\(0),
      I2 => \FSM_sequential_txState_reg[2]\(1),
      I3 => CO(0),
      I4 => shiftOut_reg_0,
      I5 => shiftOut_i_7_n_0,
...
shiftOut_i_7: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => shiftOut_reg_1,
      I1 => shiftOut_i_4_0,
      I2 => shiftOut_i_12_n_0,
      I3 => empty_INST_0_i_2_n_0,
      I4 => empty_INST_0_i_1_n_0,
      I5 => \FSM_sequential_txState_reg[2]\(2),
      O => shiftOut_i_7_n_0
    );
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  port (
    ...
    FE6_out : out STD_LOGIC;
    axi_aresetn_0 : out STD_LOGIC;
    \officialControl_reg[2]_1\ : out STD_LOGIC;
    rd_data : out STD_LOGIC_VECTOR ( 8 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  signal \myRxData[2]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_rxState[0]_i_5\ : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of \FSM_sequential_rxState[1]_i_4\ : label is "soft_lutpair49";
  attribute SOFT_HLUTNM of \FSM_sequential_rxState[2]_i_3\ : label is "soft_lutpair38";
  attribute SOFT_HLUTNM of \FSM_sequential_rxState[2]_i_7\ : label is "soft_lutpair49";
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_txState[1]_i_3\ : label is "soft_lutpair42";
  ...
  attribute SOFT_HLUTNM of PE_i_2 : label is "soft_lutpair42";
  ...
  attribute SOFT_HLUTNM of \countToMySize[0]_i_1\ : label is "soft_lutpair50";
  attribute SOFT_HLUTNM of \countToMySize[1]_i_1\ : label is "soft_lutpair40";
  attribute SOFT_HLUTNM of \countToMySize[2]_i_1\ : label is "soft_lutpair40";
  attribute SOFT_HLUTNM of \countToMySize[3]_i_2\ : label is "soft_lutpair39";
  attribute SOFT_HLUTNM of \countToMySize[3]_i_3\ : label is "soft_lutpair50";
  ...
  attribute SOFT_HLUTNM of \count[3]_i_5\ : label is "soft_lutpair44";
  attribute SOFT_HLUTNM of \latchAndDetermine[0]_i_2\ : label is "soft_lutpair37";
  ...
  attribute SOFT_HLUTNM of \myRxData[7]_i_2\ : label is "soft_lutpair39";
  ...
  attribute SOFT_HLUTNM of \rxCount[3]_i_3\ : label is "soft_lutpair48";
  ...
  attribute SOFT_HLUTNM of rxParityCheck_reg_i_2 : label is "soft_lutpair38";
  attribute SOFT_HLUTNM of rxParityCheck_reg_i_5 : label is "soft_lutpair41";
  attribute SOFT_HLUTNM of rxParityCheck_reg_i_6 : label is "soft_lutpair41";
  attribute SOFT_HLUTNM of shiftOut_i_10 : label is "soft_lutpair44";
  attribute SOFT_HLUTNM of shiftOut_i_6 : label is "soft_lutpair47";
  ...
  attribute SOFT_HLUTNM of \ticks2[0]_i_1\ : label is "soft_lutpair51";
  attribute SOFT_HLUTNM of \ticks2[1]_i_1\ : label is "soft_lutpair51";
  attribute SOFT_HLUTNM of \ticks2[2]_i_1\ : label is "soft_lutpair43";
  attribute SOFT_HLUTNM of \ticks2[3]_i_1\ : label is "soft_lutpair43";
begin
...
\FSM_sequential_rxState[0]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\FSM_sequential_rxState[1]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
\FSM_sequential_rxState[2]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"2AAAAA2A"
    )
        port map (
...
\FSM_sequential_rxState[2]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\FSM_sequential_txState[0]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"06C7C70602020202"
        ...
        port map (
      I0 => \txState__0\(0),
      I1 => \^fsm_sequential_txstate_reg[2]_0\(0),
...
edge_detect_2: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_0
     port map (
      ...
      \FSM_sequential_txState_reg[0]_1\ => \count[3]_i_5_n_0\,
      \FSM_sequential_txState_reg[0]_2\ => txFIFO_n_17,
      \FSM_sequential_txState_reg[0]_3\ => txFIFO_n_31,
      \FSM_sequential_txState_reg[0]_4\ => \FSM_sequential_txState[0]_i_4_n_0\,
      \FSM_sequential_txState_reg[1]\ => \^fsm_sequential_txstate_reg[1]_0\,
      \FSM_sequential_txState_reg[1]_0\ => \FSM_sequential_txState[1]_i_3_n_0\,
      ...
      \officialControl_reg[8]_0\ => edge_detect_2_n_7,
      outReg_reg_0 => \^outreg_reg\,
      outReg_reg_1 => edge_detect_2_n_6,
      outReg_reg_2 => edge_detect_2_n_9,
      outReg_reg_3 => outReg_reg_3,
...
edge_detect_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_1
     port map (
      ...
      \FSM_sequential_rxState_reg[0]_3\ => \FSM_sequential_rxState[2]_i_7_n_0\,
      \FSM_sequential_rxState_reg[0]_4\ => \FSM_sequential_txState[1]_i_3_n_0\,
      \FSM_sequential_rxState_reg[1]\ => edge_detect_inst_n_8,
      \FSM_sequential_rxState_reg[1]_0\ => \FSM_sequential_rxState[1]_i_4_n_0\,
      \FSM_sequential_rxState_reg[2]\(0) => edge_detect_inst_n_4,
      \FSM_sequential_rxState_reg[2]_0\ => \FSM_sequential_rxState[2]_i_3_n_0\,
      Q(2) => SECOND_STOP,
      Q(1 downto 0) => PARITY_CONTROL(3 downto 2),
      axi_aclk => axi_aclk,
      axi_aresetn => axi_aresetn,
      axi_aresetn_0(0) => edge_detect_inst_n_3,
      axi_aresetn_1 => axi_aresetn_0,
      \countToMySize_reg[0]\ => edge_detect_inst_n_12,
      \countToMySize_reg[0]_0\ => edge_detect_inst_n_14,
      \countToMySize_reg[0]_1\ => edge_detect_inst_n_18,
      \countToMySize_reg[0]_2\ => \^rxstate__0\(2),
      \countToMySize_reg[0]_3\ => \^rxstate__0\(1),
      \countToMySize_reg[0]_4\ => \^rxstate__0\(0),
      \countToMySize_reg[1]\ => edge_detect_inst_n_13,
      \countToMySize_reg[1]_0\ => edge_detect_inst_n_17,
      \countToMySize_reg[2]\ => edge_detect_inst_n_16,
      \countToMySize_reg[3]\ => edge_detect_inst_n_11,
      \countToMySize_reg[3]_0\ => edge_detect_inst_n_15,
      \countToMySize_reg[3]_1\ => edge_detect_inst_n_19,
      in_delay => in_delay_2,
      ...
      \myRxData_reg[2]\ => \myRxData[2]_i_2_n_0\,
      \myRxData_reg[3]\ => \countToMySize[3]_i_3_n_0\,
...
shiftOut_i_10: unisim.vcomponents.LUT4
    generic map(
      INIT => X"DFDD"
    )
        port map (
...
shiftOut_i_11: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
shiftOut_i_5: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => shiftOut_i_9_n_0,
      I3 => \count__0\(3),
      I4 => shiftOut_i_10_n_0,
      O => shiftOut_i_5_n_0
    );
shiftOut_i_6: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FB"
    )
        port map (
...
txFIFO: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my9x16Fifo_2
     port map (
      ...
      \FSM_sequential_txState[2]_i_3_0\ => edge_detect_2_n_6,
      \FSM_sequential_txState_reg[0]\ => txFIFO_n_31,
      \FSM_sequential_txState_reg[1]\ => \FSM_sequential_txState_reg[1]_1\,
      \FSM_sequential_txState_reg[2]\(2) => \^q\(0),
      \FSM_sequential_txState_reg[2]\(1 downto 0) => PARITY_CONTROL(3 downto 2),
      ...
      \officialControl_reg[4]\ => txFIFO_n_17,
      officialData(8 downto 0) => officialData(8 downto 0),
      outReg_reg => outReg_reg_1,
      p_42_in => p_42_in,
      rd_data(8 downto 0) => \^rd_data\(8 downto 0),
      \rd_index_reg[4]_0\(4 downto 0) => \rd_index_reg[4]\(4 downto 0),
      shiftOut_i_4_0 => shiftOut_i_11_n_0,
      shiftOut_reg => \count[3]_i_5_n_0\,
      shiftOut_reg_0 => shiftOut_i_6_n_0,
      shiftOut_reg_1 => \^fsm_sequential_txstate_reg[2]_0\(0),
      shiftOut_reg_2 => \^outreg_reg\,
      shiftOut_reg_3 => shiftOut_i_5_n_0,
      shiftOut_reg_4 => \^fsm_sequential_txstate_reg[2]_0\(1),
      \txState__0\(0) => \txState__0\(0),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial is
  ...
  signal serial_v1_0_AXI_inst_n_43 : STD_LOGIC;
...
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      ...
      \officialControl_reg[2]_0\ => serial_v1_0_AXI_inst_n_45,
      \officialControl_reg[2]_1\ => serial_v1_0_AXI_inst_n_57,
      \officialControl_reg[8]_0\ => serial_v1_0_AXI_inst_n_48,
      outReg_reg => \^outreg_reg\,
      outReg_reg_0 => serial_v1_0_AXI_inst_n_51,
      ...
      tx_out => \^tx_out\,
      watermark(4 downto 0) => watermark(4 downto 0),
      \wr_index_reg[0]\ => serial_v1_0_AXI_inst_n_43,
...
writeFifoRequest_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFAFFFF00080000"
    )
        port map (
      I0 => \rxState__0\(2),
      I1 => serial_v1_0_AXI_inst_n_51,
      I2 => \rxState__0\(1),
      I3 => \rxState__0\(0),
      I4 => axi_aresetn,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute SOFT_HLUTNM of i_740 : label is "soft_lutpair54";
  ...
  attribute SOFT_HLUTNM of i_760 : label is "soft_lutpair64";
  attribute SOFT_HLUTNM of i_761 : label is "soft_lutpair64";
  attribute SOFT_HLUTNM of i_762 : label is "soft_lutpair65";
  attribute SOFT_HLUTNM of i_763 : label is "soft_lutpair65";
  attribute SOFT_HLUTNM of i_764 : label is "soft_lutpair66";
  attribute SOFT_HLUTNM of i_765 : label is "soft_lutpair66";
  attribute SOFT_HLUTNM of i_766 : label is "soft_lutpair67";
  attribute SOFT_HLUTNM of i_767 : label is "soft_lutpair67";
