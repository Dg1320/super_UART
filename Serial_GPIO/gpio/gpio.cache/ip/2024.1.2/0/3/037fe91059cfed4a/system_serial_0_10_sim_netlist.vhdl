...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect is
  ...
  attribute SOFT_HLUTNM of shiftOut_i_4 : label is "soft_lutpair1";
begin
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my9x16Fifo is
  port (
    ...
    shiftOut_reg : in STD_LOGIC;
    shiftOut_reg_0 : in STD_LOGIC_VECTOR ( 3 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my9x16Fifo is
  ...
  attribute SOFT_HLUTNM of myParityBit_reg_i_4 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of myParityBit_reg_i_5 : label is "soft_lutpair15";
...
myParityBit_reg_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9696969655AA5A5A"
    )
        port map (
      I0 => myParityBit_reg,
      I1 => \^rd_data\(5),
      I2 => myParityBit_reg_i_4_n_0,
      I3 => myParityBit_reg_i_5_n_0,
      I4 => \axi_rdata_reg[8]\(1),
      I5 => \axi_rdata_reg[8]\(0),
      O => \officialControl_reg[1]\
    );
myParityBit_reg_i_4: unisim.vcomponents.LUT3
    generic map(
      INIT => X"96"
    )
        port map (
...
myParityBit_reg_i_6: unisim.vcomponents.LUT3
    generic map(
      INIT => X"96"
    )
        port map (
...
rd_edge: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_0
     port map (
      ...
      outReg_reg_0 => outReg_reg_0,
      \rd_index_reg[0]\ => \^rd_index_reg[0]_0\,
      write_request => write_request
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  signal my9x16Fifo_inst_n_41 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \count[3]_i_4\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \count[3]_i_5\ : label is "soft_lutpair25";
  ...
  attribute SOFT_HLUTNM of myParityBit_reg_i_2 : label is "soft_lutpair27";
  ...
  attribute SOFT_HLUTNM of shiftOut_i_9 : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of testIdle_i_2 : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \ticks2[0]_i_1\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \ticks2[1]_i_1\ : label is "soft_lutpair28";
...
\count[3]_i_4\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => PARITY_CONTROL(3),
      I3 => PARITY_CONTROL(2),
      I4 => \state1_inferred__1/i__carry_n_2\,
      O => \count[3]_i_4_n_0\
    );
...
edge_detect_2: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect
     port map (
      ...
      \FSM_sequential_state_reg[0]_0\ => edge_detect_2_n_9,
      \FSM_sequential_state_reg[0]_1\ => shiftOut_i_6_n_0,
      \FSM_sequential_state_reg[0]_2\ => my9x16Fifo_inst_n_17,
      \FSM_sequential_state_reg[1]\ => \^fsm_sequential_state_reg[1]_0\(0),
      \FSM_sequential_state_reg[1]_0\ => \FSM_sequential_state[2]_i_7_n_0\,
      \FSM_sequential_state_reg[1]_1\ => \^fsm_sequential_state_reg[0]_0\,
      \FSM_sequential_state_reg[2]\ => edge_detect_2_n_7,
      \FSM_sequential_state_reg[2]_0\ => my9x16Fifo_inst_n_40,
      Q(2) => SECOND_STOP,
      Q(1 downto 0) => PARITY_CONTROL(3 downto 2),
      axi_aclk => axi_aclk,
      axi_aresetn => axi_aresetn,
      \count_reg[0]\ => \count[3]_i_4_n_0\,
      \count_reg[0]_0\ => \count[3]_i_5_n_0\,
...
my9x16Fifo_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my9x16Fifo
     port map (
      CO(0) => \state1_inferred__1/i__carry_n_2\,
      D(8) => my9x16Fifo_inst_n_31,
      D(7) => my9x16Fifo_inst_n_32,
      D(6) => my9x16Fifo_inst_n_33,
      D(5) => my9x16Fifo_inst_n_34,
      D(4) => my9x16Fifo_inst_n_35,
      D(3) => my9x16Fifo_inst_n_36,
      D(2) => my9x16Fifo_inst_n_37,
      D(1) => my9x16Fifo_inst_n_38,
      D(0) => my9x16Fifo_inst_n_39,
      \FSM_sequential_state_reg[0]\ => \^outreg_reg\,
      \FSM_sequential_state_reg[0]_0\ => \^fsm_sequential_state_reg[1]_0\(0),
      \FSM_sequential_state_reg[0]_1\ => \^fsm_sequential_state_reg[0]_0\,
      \FSM_sequential_state_reg[1]\ => my9x16Fifo_inst_n_40,
      Q(4 downto 0) => Q(4 downto 0),
      axi_aclk => axi_aclk,
      axi_aresetn => axi_aresetn,
      axi_aresetn_0 => my9x16Fifo_inst_n_41,
      axi_awvalid => axi_awvalid,
      ...
      shiftOut_reg_0(3 downto 0) => \count__0\(3 downto 0),
      state1 => state1,
      \state__0\(1) => \state__0\(2),
      \state__0\(0) => \state__0\(0),
...
readFifoRequest_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFF5552000A000"
    )
        port map (
      I0 => axi_aresetn,
      I1 => \state__0\(1),
      I2 => state1,
      I3 => serial_v1_0_AXI_inst_n_36,
      I4 => serial_v1_0_AXI_inst_n_51,
...
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      CO(0) => keepCount0,
      \FSM_sequential_state_reg[0]_0\ => serial_v1_0_AXI_inst_n_36,
      \FSM_sequential_state_reg[0]_1\ => serial_v1_0_AXI_inst_n_51,
      \FSM_sequential_state_reg[1]_0\(0) => \state__0\(1),
      ...
      \count_reg[2]_0\ => serial_v1_0_AXI_inst_n_41,
      full => full,
      ...
      \officialControl_reg[8]_0\ => serial_v1_0_AXI_inst_n_40,
      outReg_reg => outReg_reg,
      outReg_reg_0 => serial_v1_0_AXI_inst_n_38,
      outReg_reg_1 => serial_v1_0_AXI_inst_n_39,
      ...
      readFifoRequest_reg_0 => serial_v1_0_AXI_inst_n_1,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of i_435 : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of i_436 : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of i_437 : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of i_438 : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of i_439 : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of i_440 : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of i_441 : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of i_442 : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of i_443 : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of i_444 : label is "soft_lutpair34";
  attribute SOFT_HLUTNM of i_445 : label is "soft_lutpair34";
  attribute SOFT_HLUTNM of i_446 : label is "soft_lutpair35";
  attribute SOFT_HLUTNM of i_448 : label is "soft_lutpair35";
  attribute SOFT_HLUTNM of i_449 : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of i_450 : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of \inst/serial_v1_0_AXI_inst/i_/i_/i_\ : label is "soft_lutpair29";
