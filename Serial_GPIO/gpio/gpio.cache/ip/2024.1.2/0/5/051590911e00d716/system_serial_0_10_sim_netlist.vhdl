...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_1 is
  port (
    ...
    outReg_reg_3 : out STD_LOGIC_VECTOR ( 0 to 0 );
    axi_aclk : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_1 is
  ...
  attribute SOFT_HLUTNM of \latchData_reg[8]_i_1\ : label is "soft_lutpair0";
...
\latchData_reg[8]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0100"
    )
        port map (
...
rd_edge: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_1
     port map (
      ...
      \state_reg[0]_1\(0) => \axi_rdata_reg[8]\(8),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  signal my9x16Fifo_inst_n_42 : STD_LOGIC;
  signal my9x16Fifo_inst_n_43 : STD_LOGIC;
...
my9x16Fifo_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my9x16Fifo
     port map (
      ...
      \officialBaudRate_reg[8]\(8) => my9x16Fifo_inst_n_35,
      \officialBaudRate_reg[8]\(7) => my9x16Fifo_inst_n_36,
      \officialBaudRate_reg[8]\(6) => my9x16Fifo_inst_n_37,
      \officialBaudRate_reg[8]\(5) => my9x16Fifo_inst_n_38,
      \officialBaudRate_reg[8]\(4) => my9x16Fifo_inst_n_39,
      \officialBaudRate_reg[8]\(3) => my9x16Fifo_inst_n_40,
      \officialBaudRate_reg[8]\(2) => my9x16Fifo_inst_n_41,
      \officialBaudRate_reg[8]\(1) => my9x16Fifo_inst_n_42,
      \officialBaudRate_reg[8]\(0) => my9x16Fifo_inst_n_43,
