...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_0 is
  port (
    ...
    \wr_index_reg[0]_3\ : in STD_LOGIC_VECTOR ( 0 to 0 );
...
\wr_index[4]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"4044444044444444"
    )
        port map (
      I0 => in_delay,
      I1 => wr_request0,
      I2 => \wr_index_reg[0]_2\,
      I3 => Q(3),
      I4 => \wr_index_reg[0]_3\(0),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_FIFOTEST is
  ...
  attribute SOFT_HLUTNM of \FIFO_DATA[11][8]_i_3\ : label is "soft_lutpair79";
  attribute SOFT_HLUTNM of \FIFO_DATA[12][8]_i_3\ : label is "soft_lutpair78";
  attribute SOFT_HLUTNM of \FIFO_DATA[13][8]_i_3\ : label is "soft_lutpair80";
  attribute SOFT_HLUTNM of \FIFO_DATA[14][8]_i_3\ : label is "soft_lutpair81";
  attribute SOFT_HLUTNM of \FIFO_DATA[15][8]_i_3\ : label is "soft_lutpair81";
  attribute SOFT_HLUTNM of \FIFO_DATA[1][8]_i_3\ : label is "soft_lutpair77";
  attribute SOFT_HLUTNM of \FIFO_DATA[2][8]_i_3\ : label is "soft_lutpair76";
  attribute SOFT_HLUTNM of \FIFO_DATA[3][8]_i_3\ : label is "soft_lutpair76";
  attribute SOFT_HLUTNM of \FIFO_DATA[4][8]_i_3\ : label is "soft_lutpair78";
  attribute SOFT_HLUTNM of \FIFO_DATA[5][8]_i_3\ : label is "soft_lutpair79";
  attribute SOFT_HLUTNM of \FIFO_DATA[6][8]_i_3\ : label is "soft_lutpair80";
  attribute SOFT_HLUTNM of \FIFO_DATA[7][8]_i_3\ : label is "soft_lutpair82";
  attribute SOFT_HLUTNM of \FIFO_DATA[8][8]_i_3\ : label is "soft_lutpair83";
...
wr_edge: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_0
     port map (
      ...
      clear_overflow_request_0 => wr_edge_n_162,
      full => \^full\,
      ...
      \wr_index_reg[0]_2\ => \wr_index[4]_i_4_n_0\,
      \wr_index_reg[0]_3\(0) => \^q\(3),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of axi_arready_i_1 : label is "soft_lutpair87";
  ...
  attribute SOFT_HLUTNM of \raddr[3]_i_1\ : label is "soft_lutpair87";
begin
...
myFifo: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_FIFOTEST
     port map (
      ...
      empty => empty,
      full => full,
      in_delay_reg => \^s_axi_wready\,
      in_delay_reg_0 => \^s_axi_awready\,
      in_delay_reg_1 => \^s_axi_arready\,
      in_delay_reg_2 => \^axi_rvalid_reg_0\,
      officialData(8 downto 0) => officialData(8 downto 0),
      overflow => overflow,
      p_0_in_0(1 downto 0) => p_0_in_0(1 downto 0),
      p_9_in => p_9_in,
