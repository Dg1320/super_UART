...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_1 is
  port (
    ...
    \FSM_sequential_rxState_reg[2]\ : out STD_LOGIC_VECTOR ( 0 to 0 );
    ...
    \FSM_sequential_rxState_reg[0]_0\ : in STD_LOGIC;
    axi_aresetn : in STD_LOGIC;
    ...
    \latchAndDetermine_reg[1]\ : in STD_LOGIC_VECTOR ( 3 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_1 is
  ...
  signal \myRxData[2]_i_3_n_0\ : STD_LOGIC;
  signal \myRxData[5]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_rxState[1]_i_3\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \FSM_sequential_rxState[2]_i_4\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \latchAndDetermine[1]_i_3\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \myRxData[2]_i_3\ : label is "soft_lutpair5";
begin
  E(0) <= \^e\(0);
...
\FSM_sequential_rxState[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \FSM_sequential_rxState[1]_i_2_n_0\,
      I3 => \FSM_sequential_rxState[0]_i_4_n_0\,
...
\FSM_sequential_rxState[0]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFDDDDEEEEDFFF"
    )
        port map (
      I0 => \countToMySize_reg[0]_0\,
      I1 => \^rxcount_reg[3]\,
      I2 => Q(2),
      I3 => \myRxData_reg[0]\,
      I4 => \countToMySize_reg[0]_1\,
...
\FSM_sequential_rxState[0]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0404040404040F04"
    )
        port map (
      I0 => \FSM_sequential_rxState_reg[0]_1\,
      I1 => CO(0),
      I2 => \^rxcount_reg[3]\,
      I3 => \FSM_sequential_rxState_reg[0]_2\,
      I4 => \countToMySize_reg[0]_1\,
      I5 => Q(2),
...
\FSM_sequential_rxState[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"11111111FF00F100"
    )
        port map (
      I0 => \FSM_sequential_rxState[1]_i_2_n_0\,
      I1 => \FSM_sequential_rxState[1]_i_3_n_0\,
      I2 => \FSM_sequential_rxState[2]_i_3_n_0\,
      I3 => \countToMySize_reg[0]_1\,
      I4 => \countToMySize_reg[0]_0\,
      I5 => \FSM_sequential_rxState[2]_i_4_n_0\,
...
\FSM_sequential_rxState[1]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0001303D"
    )
        port map (
...
\FSM_sequential_rxState[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00111100FFFF0100"
        ...
        port map (
      I0 => \^rxcount_reg[3]\,
      I1 => \FSM_sequential_rxState_reg[2]_8\,
      I2 => \FSM_sequential_rxState[2]_i_3_n_0\,
      I3 => \countToMySize_reg[0]_1\,
      I4 => \countToMySize_reg[0]_0\,
      I5 => \FSM_sequential_rxState[2]_i_4_n_0\,
...
\FSM_sequential_rxState[2]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"55550013"
    )
        port map (
...
PE_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
        ...
        port map (
      I0 => \latchAndDetermine_reg[1]\(3),
      I1 => \latchAndDetermine_reg[1]\(0),
      I2 => \latchAndDetermine_reg[1]\(1),
      I3 => \latchAndDetermine_reg[1]\(2),
      I4 => \^e\(0),
      O => \^rxcount_reg[3]\
    );
\countToMySize[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \countToMySize_reg[0]_1\,
      I5 => \^rxcount_reg[3]\,
      O => \FSM_sequential_rxState_reg[2]\(0)
    );
in_delay_reg: unisim.vcomponents.FDRE
     port map (
      C => axi_aclk,
...
\latchAndDetermine[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFE0002"
        ...
        port map (
      I0 => rx_in,
      I1 => \latchAndDetermine_reg[0]\,
      I2 => \latchAndDetermine_reg[1]\(3),
...
\latchAndDetermine[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFEFFF00002000"
        ...
        port map (
      I0 => rx_in,
      I1 => \latchAndDetermine_reg[1]\(2),
      I2 => \latchAndDetermine_reg[1]\(3),
      I3 => \latchAndDetermine_reg[1]_0\,
...
\myRxData[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \myRxData[8]_i_2_n_0\,
      I3 => \myRxData_reg[8]\(3),
      I4 => \myRxData_reg[8]\(2),
      I5 => \myRxData_reg[0]_0\,
...
\myRxData[2]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FBFF"
    )
        port map (
...
\myRxData[5]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\myRxData[8]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \myRxData_reg[8]\(3),
      I4 => \myRxData_reg[8]\(2),
      I5 => \myRxData_reg[8]_0\,
      O => \FSM_sequential_rxState_reg[2]_0\
    );
\myRxData[8]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my9x16Fifo is
  ...
  attribute SOFT_HLUTNM of \rd_index[2]_i_1__0\ : label is "soft_lutpair18";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my9x16Fifo_2 is
  ...
  attribute SOFT_HLUTNM of \rd_index[2]_i_1\ : label is "soft_lutpair34";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  signal \^fsm_sequential_rxstate_reg[1]_0\ : STD_LOGIC;
  ...
  signal \myRxData[2]_i_4_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of FE_i_3 : label is "soft_lutpair37";
  attribute SOFT_HLUTNM of \FSM_sequential_rxState[0]_i_6\ : label is "soft_lutpair49";
  ...
  attribute SOFT_HLUTNM of PE_i_2 : label is "soft_lutpair40";
  attribute SOFT_HLUTNM of PE_i_4 : label is "soft_lutpair45";
  ...
  attribute SOFT_HLUTNM of \count[3]_i_5\ : label is "soft_lutpair42";
  attribute SOFT_HLUTNM of \latchAndDetermine[0]_i_2\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of \latchAndDetermine[1]_i_2\ : label is "soft_lutpair46";
  ...
  attribute SOFT_HLUTNM of \myRxData[2]_i_2\ : label is "soft_lutpair49";
  attribute SOFT_HLUTNM of \raddr[3]_i_1\ : label is "soft_lutpair43";
  attribute SOFT_HLUTNM of \rxCount[0]_i_1\ : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of \rxCount[1]_i_1\ : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of \rxCount[3]_i_2\ : label is "soft_lutpair37";
  attribute SOFT_HLUTNM of \rxCount[3]_i_3\ : label is "soft_lutpair45";
  ...
  attribute SOFT_HLUTNM of rxParityCheck_reg_i_2 : label is "soft_lutpair40";
  attribute SOFT_HLUTNM of rxParityCheck_reg_i_5 : label is "soft_lutpair39";
  attribute SOFT_HLUTNM of rxParityCheck_reg_i_6 : label is "soft_lutpair39";
  attribute SOFT_HLUTNM of shiftOut_i_11 : label is "soft_lutpair42";
  attribute SOFT_HLUTNM of shiftOut_i_8 : label is "soft_lutpair47";
  ...
  attribute SOFT_HLUTNM of testIdle_i_3 : label is "soft_lutpair47";
  attribute SOFT_HLUTNM of \ticks2[0]_i_1\ : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of \ticks2[1]_i_1\ : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of \ticks2[2]_i_1\ : label is "soft_lutpair41";
  attribute SOFT_HLUTNM of \ticks2[3]_i_1\ : label is "soft_lutpair41";
begin
  \FSM_sequential_rxState_reg[1]_0\ <= \^fsm_sequential_rxstate_reg[1]_0\;
...
FE_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\FSM_sequential_rxState[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => \^rxstate__0\(2),
      I1 => \^determinedbit\,
      I2 => \rxState1_inferred__0/i__carry_n_2\,
      I3 => \^rxstate__0\(1),
      I4 => \rxParityCheck__0\,
      I5 => \^rxstate__0\(0),
...
PE_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
edge_detect_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_1
     port map (
      ...
      \FSM_sequential_rxState_reg[0]_1\ => \FSM_sequential_rxState[0]_i_5_n_0\,
      ...
      \FSM_sequential_rxState_reg[2]\(0) => edge_detect_inst_n_4,
      \FSM_sequential_rxState_reg[2]_0\ => edge_detect_inst_n_10,
      ...
      \FSM_sequential_rxState_reg[2]_8\ => \FSM_sequential_rxState[2]_i_2_n_0\,
      Q(2) => SECOND_STOP,
      Q(1 downto 0) => PARITY_CONTROL(3 downto 2),
      axi_aclk => axi_aclk,
      axi_aresetn => axi_aresetn,
      axi_aresetn_0(0) => edge_detect_inst_n_3,
      \countToMySize_reg[0]\ => \^rxstate__0\(0),
      \countToMySize_reg[0]_0\ => \^rxstate__0\(2),
      \countToMySize_reg[0]_1\ => \^rxstate__0\(1),
      \countToMySize_reg[1]\ => edge_detect_inst_n_16,
      in_delay => in_delay_2,
      in_delay_reg_0 => \^outsignal\,
      \latchAndDetermine_reg[0]\ => \latchAndDetermine[0]_i_2_n_0\,
      \latchAndDetermine_reg[0]_0\ => \^latchanddetermine_reg[0]_0\,
      \latchAndDetermine_reg[1]\(3) => \rxCount_reg_n_0_[3]\,
      \latchAndDetermine_reg[1]\(2) => \rxCount_reg_n_0_[2]\,
      \latchAndDetermine_reg[1]\(1) => \rxCount_reg_n_0_[1]\,
      \latchAndDetermine_reg[1]\(0) => \rxCount_reg_n_0_[0]\,
      \latchAndDetermine_reg[1]_0\ => \latchAndDetermine[1]_i_2_n_0\,
      myRxData(0) => myRxData(8),
      \myRxData_reg[0]\ => \^determinedbit\,
      \myRxData_reg[0]_0\ => \myRxData_reg_n_0_[0]\,
      \myRxData_reg[2]\ => \myRxData[2]_i_4_n_0\,
      ...
      sixteenXslower_reg => edge_detect_inst_n_6,
      sixteenXslower_reg_0 => \^sixteenxslower_reg_0\,
...
\myRxData[2]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\myRxData[2]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\rxCount[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0076"
    )
        port map (
...
\rxCount[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00767600"
    )
        port map (
...
\rxCount[3]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"3E"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial is
  ...
  signal serial_v1_0_AXI_inst_n_52 : STD_LOGIC;
  signal serial_v1_0_AXI_inst_n_53 : STD_LOGIC;
...
PE_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \rxState__0\(0),
      I2 => serial_v1_0_AXI_inst_n_53,
      I3 => axi_aresetn,
      I4 => serial_v1_0_AXI_inst_n_52,
      I5 => \^parityerror\,
      O => PE_i_1_n_0
    );
...
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      ...
      FE6_out => FE6_out,
      FE_reg_0 => FE_i_1_n_0,
      \FSM_sequential_rxState_reg[1]_0\ => serial_v1_0_AXI_inst_n_52,
      ...
      \rxCount_reg[3]_0\ => serial_v1_0_AXI_inst_n_53,
      \rxState__0\(2 downto 0) => \rxState__0\(2 downto 0),
      rx_in => rx_in,
...
writeFifoRequest_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFCFFFF00040000"
    )
        port map (
      I0 => serial_v1_0_AXI_inst_n_53,
      I1 => \rxState__0\(2),
      I2 => \rxState__0\(1),
      I3 => \rxState__0\(0),
      I4 => axi_aresetn,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of i_734 : label is "soft_lutpair50";
  attribute SOFT_HLUTNM of i_735 : label is "soft_lutpair51";
  attribute SOFT_HLUTNM of i_736 : label is "soft_lutpair51";
  attribute SOFT_HLUTNM of i_737 : label is "soft_lutpair52";
  attribute SOFT_HLUTNM of i_738 : label is "soft_lutpair52";
  attribute SOFT_HLUTNM of i_739 : label is "soft_lutpair53";
  attribute SOFT_HLUTNM of i_740 : label is "soft_lutpair53";
  attribute SOFT_HLUTNM of i_741 : label is "soft_lutpair54";
  attribute SOFT_HLUTNM of i_742 : label is "soft_lutpair54";
  attribute SOFT_HLUTNM of i_743 : label is "soft_lutpair55";
  attribute SOFT_HLUTNM of i_744 : label is "soft_lutpair55";
  attribute SOFT_HLUTNM of i_745 : label is "soft_lutpair56";
  attribute SOFT_HLUTNM of i_747 : label is "soft_lutpair56";
  attribute SOFT_HLUTNM of i_748 : label is "soft_lutpair57";
  attribute SOFT_HLUTNM of i_749 : label is "soft_lutpair57";
  attribute SOFT_HLUTNM of i_750 : label is "soft_lutpair58";
  attribute SOFT_HLUTNM of i_751 : label is "soft_lutpair58";
  attribute SOFT_HLUTNM of i_752 : label is "soft_lutpair59";
  attribute SOFT_HLUTNM of i_753 : label is "soft_lutpair59";
  attribute SOFT_HLUTNM of i_754 : label is "soft_lutpair60";
  attribute SOFT_HLUTNM of i_755 : label is "soft_lutpair60";
  attribute SOFT_HLUTNM of i_756 : label is "soft_lutpair61";
  attribute SOFT_HLUTNM of i_757 : label is "soft_lutpair61";
  attribute SOFT_HLUTNM of i_758 : label is "soft_lutpair62";
  attribute SOFT_HLUTNM of i_759 : label is "soft_lutpair62";
  attribute SOFT_HLUTNM of i_760 : label is "soft_lutpair63";
  attribute SOFT_HLUTNM of i_761 : label is "soft_lutpair63";
  attribute SOFT_HLUTNM of i_762 : label is "soft_lutpair64";
  attribute SOFT_HLUTNM of i_763 : label is "soft_lutpair64";
  attribute SOFT_HLUTNM of i_764 : label is "soft_lutpair65";
  attribute SOFT_HLUTNM of i_765 : label is "soft_lutpair65";
  attribute SOFT_HLUTNM of \inst/serial_v1_0_AXI_inst/i_/i_/i_\ : label is "soft_lutpair50";
