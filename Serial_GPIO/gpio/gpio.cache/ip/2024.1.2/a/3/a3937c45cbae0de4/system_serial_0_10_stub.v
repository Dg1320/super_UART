...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(wr_request, rd_request, 
  ...
  rd_index, watermark, enableing, testing, txBaud, axi_aclk, axi_aresetn, axi_awaddr, axi_awprot, 
...
/* synthesis syn_force_seq_prim="axi_aclk" */;
  ...
  output enableing;
  output testing;
  output txBaud /* synthesis syn_isclock = 1 */;
