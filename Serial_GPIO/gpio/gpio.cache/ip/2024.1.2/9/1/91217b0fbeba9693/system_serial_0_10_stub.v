...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(wr_request, rd_request, 
  clear_overflow_request, wr_data, rd_data, empty, full, baudClockOut, tx_out, overflow, wr_index, 
  rd_index, watermark, enableing, testing, txBaud, baudTick, TXGo, TXIdle, axi_aclk, axi_aresetn, 
...
/* synthesis syn_black_box black_box_pad_pin="wr_request,rd_request,clear_overflow_request,wr_data[8:0],rd_data[8:0],empty,full,baudClockOut,tx_out,overflow,wr_index[4:0],rd_index[4:0],watermark[4:0],enableing,testing,txBaud,baudTick,TXIdle,axi_aresetn,axi_awaddr[3:0],axi_awprot[2:0],axi_awvalid,axi_awready,axi_wdata[31:0],axi_wstrb[3:0],axi_wvalid,axi_wready,axi_bresp[1:0],axi_bvalid,axi_bready,axi_araddr[3:0],axi_arprot[2:0],axi_arvalid,axi_arready,axi_rdata[31:0],axi_rresp[1:0],axi_rvalid,axi_rready" */
/* synthesis syn_force_seq_prim="TXGo" */
/* synthesis syn_force_seq_prim="axi_aclk" */;
  ...
  output txBaud;
  output baudTick;
  output TXGo /* synthesis syn_isclock = 1 */;
  output TXIdle;
