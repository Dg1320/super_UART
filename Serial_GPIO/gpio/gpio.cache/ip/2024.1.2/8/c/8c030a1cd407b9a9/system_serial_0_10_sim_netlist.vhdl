...
\FSM_sequential_txState[2]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => \FSM_sequential_txState_reg[2]_3\,
      O => \^axi_aresetn_0\
    );
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_1 is
  port (
    ...
    \FSM_sequential_rxState_reg[1]_1\ : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_1 is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_rxState[1]_i_3\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \FSM_sequential_rxState[2]_i_4\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \FSM_sequential_rxState[2]_i_6\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \myRxData[2]_i_3\ : label is "soft_lutpair6";
begin
  axi_aresetn_0 <= \^axi_aresetn_0\;
  outReg_reg_0 <= \^outreg_reg_0\;
  sixteenXfasterTick <= \^sixteenxfastertick\;
FE_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4045"
    )
        port map (
...
\FSM_sequential_rxState[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \FSM_sequential_rxState_reg[1]_1\,
...
\FSM_sequential_rxState[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \FSM_sequential_rxState_reg[2]_7\,
      I2 => rx_in,
      I3 => \FSM_sequential_rxState[2]_i_4_n_0\,
      I4 => \FSM_sequential_rxState[2]_i_5_n_0\,
      I5 => \rxCount_reg[0]_1\,
...
\FSM_sequential_rxState[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => Q(0),
      I4 => Q(1),
      I5 => \FSM_sequential_rxState[2]_i_6_n_0\,
      O => \FSM_sequential_rxState[2]_i_2_n_0\
    );
\FSM_sequential_rxState[2]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"F302"
    )
        port map (
...
\countToMySize[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"20200020"
    )
        port map (
...
\latchAndDetermine[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => \latchAndDetermine_reg[0]_0\,
      O => rx_in_2
    );
\latchAndDetermine[0]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my9x16Fifo is
  ...
  attribute SOFT_HLUTNM of \rd_index[2]_i_1\ : label is "soft_lutpair19";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my9x16Fifo_2 is
  ...
  attribute SOFT_HLUTNM of \rd_index[2]_i_1__0\ : label is "soft_lutpair35";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_rxState[0]_i_4\ : label is "soft_lutpair43";
  attribute SOFT_HLUTNM of \FSM_sequential_rxState[1]_i_4\ : label is "soft_lutpair40";
  attribute SOFT_HLUTNM of \FSM_sequential_rxState[2]_i_3\ : label is "soft_lutpair40";
  ...
  attribute SOFT_HLUTNM of PE_i_2 : label is "soft_lutpair39";
  attribute SOFT_HLUTNM of PE_i_4 : label is "soft_lutpair47";
  ...
  attribute SOFT_HLUTNM of \countToMySize[0]_i_1\ : label is "soft_lutpair47";
  ...
  attribute SOFT_HLUTNM of \myRxData[2]_i_2\ : label is "soft_lutpair43";
  ...
  attribute SOFT_HLUTNM of \rxCount[2]_i_1\ : label is "soft_lutpair44";
  attribute SOFT_HLUTNM of \rxCount[3]_i_3\ : label is "soft_lutpair44";
  ...
  attribute SOFT_HLUTNM of rxParityCheck_reg_i_2 : label is "soft_lutpair39";
  attribute SOFT_HLUTNM of rxParityCheck_reg_i_5 : label is "soft_lutpair38";
  attribute SOFT_HLUTNM of rxParityCheck_reg_i_6 : label is "soft_lutpair38";
  attribute SOFT_HLUTNM of shiftOut_i_11 : label is "soft_lutpair42";
  attribute SOFT_HLUTNM of shiftOut_i_7 : label is "soft_lutpair48";
  ...
  attribute SOFT_HLUTNM of testIdle_i_2 : label is "soft_lutpair48";
...
\FSM_sequential_rxState[0]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0008"
    )
        port map (
...
\FSM_sequential_rxState[1]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\FSM_sequential_rxState[2]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
edge_detect_2: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_0
     port map (
      ...
      \FSM_sequential_txState_reg[2]_1\ => \^wr_index_reg[0]\,
      \FSM_sequential_txState_reg[2]_2\ => \count[3]_i_5_n_0\,
      \FSM_sequential_txState_reg[2]_3\ => txFIFO_n_18,
      Q(0) => SECOND_STOP,
      axi_aclk => axi_aclk,
...
edge_detect_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_1
     port map (
      ...
      \FSM_sequential_rxState_reg[0]\ => edge_detect_inst_n_10,
      \FSM_sequential_rxState_reg[0]_0\ => \FSM_sequential_rxState[0]_i_4_n_0\,
      \FSM_sequential_rxState_reg[0]_1\ => \FSM_sequential_rxState[0]_i_5_n_0\,
      \FSM_sequential_rxState_reg[0]_2\ => \^fsm_sequential_rxstate_reg[1]_0\,
      \FSM_sequential_rxState_reg[1]\ => \FSM_sequential_rxState_reg[1]_1\,
      \FSM_sequential_rxState_reg[1]_0\ => edge_detect_inst_n_9,
      \FSM_sequential_rxState_reg[1]_1\ => \FSM_sequential_rxState[1]_i_4_n_0\,
      \FSM_sequential_rxState_reg[2]\ => edge_detect_inst_n_11,
      \FSM_sequential_rxState_reg[2]_0\ => edge_detect_inst_n_12,
      \FSM_sequential_rxState_reg[2]_1\ => edge_detect_inst_n_13,
      \FSM_sequential_rxState_reg[2]_2\ => edge_detect_inst_n_14,
      \FSM_sequential_rxState_reg[2]_3\ => edge_detect_inst_n_15,
      \FSM_sequential_rxState_reg[2]_4\ => edge_detect_inst_n_16,
      \FSM_sequential_rxState_reg[2]_5\ => edge_detect_inst_n_18,
      \FSM_sequential_rxState_reg[2]_6\ => edge_detect_inst_n_19,
      \FSM_sequential_rxState_reg[2]_7\ => \FSM_sequential_rxState[2]_i_3_n_0\,
      Q(2) => SECOND_STOP,
      Q(1 downto 0) => PARITY_CONTROL(3 downto 2),
      axi_aclk => axi_aclk,
      axi_aresetn => axi_aresetn,
      axi_aresetn_0 => axi_aresetn_0,
      axi_aresetn_1 => edge_detect_inst_n_5,
      \countToMySize_reg[0]\ => \rxCount_reg_n_0_[2]\,
      \countToMySize_reg[0]_0\ => \rxCount_reg_n_0_[1]\,
      \countToMySize_reg[0]_1\ => \rxCount_reg_n_0_[0]\,
      \countToMySize_reg[1]\ => edge_detect_inst_n_17,
      in_delay => in_delay_2,
      ...
      p_0_in6_in => \^p_0_in6_in\,
      p_0_in_0 => p_0_in_0,
      \rxCount_reg[0]\ => \^rxstate__0\(0),
      \rxCount_reg[0]_0\ => \^rxstate__0\(1),
      \rxCount_reg[0]_1\ => \^rxstate__0\(2),
      \rxParityCheck__0\ => \rxParityCheck__0\,
      rx_in => rx_in,
      rx_in_0 => edge_detect_inst_n_8,
      rx_in_1 => edge_detect_inst_n_20,
      rx_in_2 => edge_detect_inst_n_21,
      sixteenXfasterTick => sixteenXfasterTick,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial is
  ...
  signal serial_v1_0_AXI_inst_n_15 : STD_LOGIC;
  ...
  signal serial_v1_0_AXI_inst_n_66 : STD_LOGIC;
...
PE_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFF02000000"
        ...
        port map (
      I0 => serial_v1_0_AXI_inst_n_50,
      I1 => \rxState__0\(0),
      I2 => serial_v1_0_AXI_inst_n_52,
      I3 => serial_v1_0_AXI_inst_n_51,
      I4 => axi_aresetn,
      I5 => \^parityerror\,
      O => PE_i_1_n_0
    );
...
readFifoRequest_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => serial_v1_0_AXI_inst_n_12,
      O => readFifoRequest_i_1_n_0
    );
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      CO(0) => serial_v1_0_AXI_inst_n_13,
      FE_reg_0 => FE_i_1_n_0,
      \FSM_sequential_rxState_reg[1]_0\ => serial_v1_0_AXI_inst_n_51,
      \FSM_sequential_rxState_reg[1]_1\ => serial_v1_0_AXI_inst_n_66,
      \FSM_sequential_txState_reg[0]_0\ => serial_v1_0_AXI_inst_n_49,
      \FSM_sequential_txState_reg[1]_0\ => serial_v1_0_AXI_inst_n_44,
      \FSM_sequential_txState_reg[1]_1\ => serial_v1_0_AXI_inst_n_45,
      \FSM_sequential_txState_reg[2]_0\(1 downto 0) => \txState__0\(2 downto 1),
      \FSM_sequential_txState_reg[2]_1\ => serial_v1_0_AXI_inst_n_43,
      PE_reg_0 => PE_i_1_n_0,
      Q(1 downto 0) => \^q\(1 downto 0),
      TXGo => TXGo,
      TXIdle => \^txidle\,
      aw_en_reg_0 => serial_v1_0_AXI_inst_n_15,
      ...
      \officialControl_reg[3]_0\ => serial_v1_0_AXI_inst_n_50,
      outReg_reg => \^outreg_reg\,
      outReg_reg_0 => serial_v1_0_AXI_inst_n_47,
      outReg_reg_1 => serial_v1_0_AXI_inst_n_48,
      outReg_reg_2 => serial_v1_0_AXI_inst_n_52,
      outReg_reg_3 => \outReg_i_1__1_n_0\,
      outReg_reg_4 => \outReg_i_1__0_n_0\,
      outReg_reg_5 => outReg_i_1_n_0,
      outSignal => outSignal,
      p_0_in6_in => p_0_in6_in,
      parityError => \^parityerror\,
      rd_data(8 downto 0) => rd_data(8 downto 0),
      \rd_index_reg[4]\(4 downto 0) => \rd_index_reg[4]\(4 downto 0),
      readFifoRequest_reg_0 => serial_v1_0_AXI_inst_n_12,
      ...
      tx_out => \^tx_out\,
      watermark(4 downto 0) => watermark(4 downto 0),
      \wr_index_reg[0]\ => serial_v1_0_AXI_inst_n_40,
...
shiftOut_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"BBBFBBBB88808888"
        ...
        port map (
      I0 => serial_v1_0_AXI_inst_n_44,
      I1 => axi_aresetn,
      I2 => serial_v1_0_AXI_inst_n_45,
      I3 => serial_v1_0_AXI_inst_n_47,
      I4 => serial_v1_0_AXI_inst_n_43,
      I5 => \^tx_out\,
      O => shiftOut_i_1_n_0
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute SOFT_HLUTNM of \inst/serial_v1_0_AXI_inst/i_/i_/i_\ : label is "soft_lutpair51";
