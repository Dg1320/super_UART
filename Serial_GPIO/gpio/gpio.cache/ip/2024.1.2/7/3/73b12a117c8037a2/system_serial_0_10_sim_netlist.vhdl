...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  signal myWatermark0 : STD_LOGIC_VECTOR ( 4 downto 1 );
  signal \myWatermark[0]_i_1_n_0\ : STD_LOGIC;
  signal \myWatermark[4]_i_1_n_0\ : STD_LOGIC;
  signal \myWatermark[4]_i_3_n_0\ : STD_LOGIC;
  ...
  signal pre_read_port_data : STD_LOGIC_VECTOR ( 8 downto 0 );
  ...
  attribute SOFT_HLUTNM of \myWatermark[0]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \myWatermark[1]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \myWatermark[3]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \myWatermark[4]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \officialBaudRate[31]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \raddr[3]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \readIndex[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \readIndex[2]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \readIndex[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \readIndex[4]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \writeIndex[1]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \writeIndex[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \writeIndex[3]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \writeIndex[4]_i_1\ : label is "soft_lutpair0";
begin
...
\myWatermark[0]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
      I0 => \^wr_index\(0),
      I1 => \^rd_index\(0),
      O => \myWatermark[0]_i_1_n_0\
    );
\myWatermark[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2DD2"
    )
        port map (
...
\myWatermark[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\myWatermark[3]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"69"
    )
        port map (
      I0 => \myWatermark[4]_i_3_n_0\,
      I1 => \^rd_index\(3),
      I2 => \^wr_index\(3),
      O => myWatermark0(3)
    );
\myWatermark[4]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => wr_request,
      I1 => rd_request,
      O => \myWatermark[4]_i_1_n_0\
    );
\myWatermark[4]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"718E8E71"
    )
        port map (
...
\myWatermark[4]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \^wr_index\(1),
      I5 => \^rd_index\(1),
      O => \myWatermark[4]_i_3_n_0\
    );
\myWatermark_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => axi_aclk,
      CE => \myWatermark[4]_i_1_n_0\,
      D => \myWatermark[0]_i_1_n_0\,
      Q => watermark(0),
      R => '0'
    );
\myWatermark_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => axi_aclk,
      CE => \myWatermark[4]_i_1_n_0\,
      D => myWatermark0(1),
...
\myWatermark_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => axi_aclk,
      CE => \myWatermark[4]_i_1_n_0\,
      D => myWatermark0(2),
...
\myWatermark_reg[3]\: unisim.vcomponents.FDRE
     port map (
      C => axi_aclk,
      CE => \myWatermark[4]_i_1_n_0\,
      D => myWatermark0(3),
...
\myWatermark_reg[4]\: unisim.vcomponents.FDRE
     port map (
      C => axi_aclk,
      CE => \myWatermark[4]_i_1_n_0\,
      D => myWatermark0(4),
...
\readIndex[0]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\readIndex[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\readIndex[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
...
\readIndex[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7F80"
    )
        port map (
...
\readIndex[4]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\readIndex[4]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFF8000"
    )
        port map (
...
\readIndex_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => axi_aclk,
      CE => readIndex,
      D => \p_0_in__1\(2),
...
\readIndex_reg[3]\: unisim.vcomponents.FDRE
     port map (
      C => axi_aclk,
      CE => readIndex,
      D => \p_0_in__1\(3),
...
\readIndex_reg[4]\: unisim.vcomponents.FDRE
     port map (
      C => axi_aclk,
      CE => readIndex,
      D => \p_0_in__1\(4),
...
\writeIndex[0]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\writeIndex[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\writeIndex[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
...
\writeIndex[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7F80"
    )
        port map (
...
\writeIndex[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFF8000"
    )
        port map (
...
\writeIndex_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => axi_aclk,
      CE => wr_request,
      D => \p_0_in__0\(2),
...
\writeIndex_reg[3]\: unisim.vcomponents.FDRE
     port map (
      C => axi_aclk,
      CE => wr_request,
      D => \p_0_in__0\(3),
...
\writeIndex_reg[4]\: unisim.vcomponents.FDRE
     port map (
      C => axi_aclk,
      CE => wr_request,
      D => \p_0_in__0\(4),
