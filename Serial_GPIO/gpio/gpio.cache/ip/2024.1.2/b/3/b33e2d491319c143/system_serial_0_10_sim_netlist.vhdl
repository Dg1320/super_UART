...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_0 is
  ...
  attribute SOFT_HLUTNM of \wr_index[4]_i_2\ : label is "soft_lutpair1";
begin
...
\wr_index[4]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"0D"
    )
        port map (
...
\wr_index[4]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_FIFOTEST is
  ...
  signal fifo_is_full_i_3_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of fifo_is_full_i_3 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \myReadData[8]_i_10\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \myReadData[8]_i_11\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \myReadData[8]_i_12\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \myReadData[8]_i_13\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \myReadData[8]_i_14\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \myReadData[8]_i_15\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \myReadData[8]_i_16\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \myReadData[8]_i_17\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \myReadData[8]_i_18\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \myReadData[8]_i_19\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \myReadData[8]_i_20\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \myReadData[8]_i_21\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \myReadData[8]_i_22\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \myReadData[8]_i_23\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \myReadData[8]_i_9\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \rd_index[0]_i_1\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \wr_index[0]_i_1\ : label is "soft_lutpair14";
...
fifo_is_full_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"EBFF282828282828"
    )
        port map (
      I0 => fifo_is_full_i_2_n_0,
      I1 => \^rd_index_reg[4]_0\(4),
      I2 => \^q\(4),
      I3 => fifo_is_full_i_3_n_0,
      I4 => axi_aresetn,
      I5 => \^full\,
      O => fifo_is_full_i_1_n_0
    );
fifo_is_full_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"8E"
    )
        port map (
...
fifo_is_full_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"8E"
    )
        port map (
      I0 => \watermark[4]_INST_0_i_2_n_0\,
      I1 => \^rd_index_reg[4]_0\(3),
      I2 => \^q\(3),
      O => fifo_is_full_i_3_n_0
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  attribute SOFT_HLUTNM of \officialBaudRate[31]_i_2\ : label is "soft_lutpair16";
