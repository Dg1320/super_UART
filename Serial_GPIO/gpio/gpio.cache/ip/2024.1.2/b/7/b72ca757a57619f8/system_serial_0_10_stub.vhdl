...
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ system_serial_0_10_stub.vhdl
...
attribute black_box_pad_pin of stub : architecture is "wr_request,rd_request,clear_overflow_request,wr_data[8:0],rd_data[8:0],empty,full,baudClockOut,tx_out,overflow,wr_index[4:0],rd_index[4:0],watermark[4:0],enableing,testing,txBaud,baudTick,sixteenXslowerOut,axi_aclk,axi_aresetn,axi_awaddr[3:0],axi_awprot[2:0],axi_awvalid,axi_awready,axi_wdata[31:0],axi_wstrb[3:0],axi_wvalid,axi_wready,axi_bresp[1:0],axi_bvalid,axi_bready,axi_araddr[3:0],axi_arprot[2:0],axi_arvalid,axi_arready,axi_rdata[31:0],axi_rresp[1:0],axi_rvalid,axi_rready";
attribute X_CORE_INFO : string;
attribute X_CORE_INFO of stub : architecture is "serial,Vivado 2024.1.2";
begin
end;
