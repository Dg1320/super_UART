...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_0 is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FIFO_DATA[0][8]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \FIFO_DATA[10][8]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \FIFO_DATA[11][8]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \FIFO_DATA[12][8]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \FIFO_DATA[13][8]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \FIFO_DATA[14][8]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \FIFO_DATA[15][8]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \FIFO_DATA[1][8]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \FIFO_DATA[2][8]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \FIFO_DATA[3][8]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \FIFO_DATA[4][8]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \FIFO_DATA[5][8]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \FIFO_DATA[6][8]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \FIFO_DATA[7][8]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \FIFO_DATA[8][8]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \FIFO_DATA[9][8]_i_1\ : label is "soft_lutpair14";
begin
  p_9_in <= \^p_9_in\;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_3 is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_txState[1]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \FSM_sequential_txState[1]_i_4\ : label is "soft_lutpair1";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my9x16Fifo is
  ...
  signal write_request : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_txState[0]_i_9\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of empty_INST_0_i_1 : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of full_INST_0 : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of full_INST_0_i_1 : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \rd_index[1]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \rd_index[2]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \rd_index[3]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \rd_index[4]_i_2\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \watermark[0]_INST_0\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \watermark[1]_INST_0\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \watermark[3]_INST_0\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \watermark[4]_INST_0\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \wr_index[1]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \wr_index[2]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \wr_index[3]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \wr_index[4]_i_2\ : label is "soft_lutpair21";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_txState[0]_i_6\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \FSM_sequential_txState[0]_i_7\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \FSM_sequential_txState[0]_i_8\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \FSM_sequential_txState[1]_i_3\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \count[3]_i_3\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of shiftOut_i_7 : label is "soft_lutpair10";
...
\FSM_sequential_txState_reg[0]\: unisim.vcomponents.FDRE
     port map (
      ...
      R => \FSM_sequential_txState_reg[2]_2\
    );
...
regularBaudRate: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_3
     port map (
      ...
      \FSM_sequential_txState_reg[0]\ => \FSM_sequential_txState_reg[0]_2\,
      \FSM_sequential_txState_reg[0]_0\ => \count[3]_i_5_n_0\,
      \FSM_sequential_txState_reg[0]_1\ => \FSM_sequential_txState[0]_i_3_n_0\,
      ...
      \FSM_sequential_txState_reg[1]_2\ => \FSM_sequential_txState[1]_i_3_n_0\,
      \FSM_sequential_txState_reg[2]\ => \FSM_sequential_txState_reg[2]_1\,
      \FSM_sequential_txState_reg[2]_0\ => \^fsm_sequential_txstate_reg[2]_0\,
      \FSM_sequential_txState_reg[2]_1\ => \^fsm_sequential_txstate_reg[0]_0\,
      ...
      shiftOut_reg_0 => shiftOut_i_7_n_0
    );
...
myTransmitter: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter
     port map (
      ...
      \FSM_sequential_txState_reg[0]_1\ => txFIFO_n_1,
      \FSM_sequential_txState_reg[0]_2\ => \^officialcontrol_reg[4]_0\,
      ...
      \FSM_sequential_txState_reg[2]_2\ => txFIFO_n_17,
      Q(2) => SECOND_STOP,
...
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      ...
      \FSM_sequential_txState_reg[2]_0\ => serial_v1_0_AXI_inst_n_80,
      Q(1 downto 0) => \^q\(1 downto 0),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute SOFT_HLUTNM of i_436 : label is "soft_lutpair32";
  ...
  attribute SOFT_HLUTNM of i_443 : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of i_444 : label is "soft_lutpair36";
