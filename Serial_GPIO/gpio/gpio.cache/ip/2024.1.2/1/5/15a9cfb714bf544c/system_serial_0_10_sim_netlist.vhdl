...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_1 is
  port (
    ...
    sixteenXslowerOut : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
...
\outReg_i_1__1\: unisim.vcomponents.LUT6
    generic map(
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  signal \ticks2[3]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \ticks2[3]_i_2\ : label is "soft_lutpair24";
...
\ticks2[3]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7F80"
    )
        port map (
...
shiftOut_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => axi_aresetn,
      I3 => serial_v1_0_AXI_inst_n_33,
      I4 => serial_v1_0_AXI_inst_n_32,
      I5 => \^tx_out\,
      O => shiftOut_i_1_n_0
    );
