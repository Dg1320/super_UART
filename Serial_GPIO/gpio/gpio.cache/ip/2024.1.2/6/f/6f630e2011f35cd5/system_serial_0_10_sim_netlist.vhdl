...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect is
  port (
    ...
    \rd_index_reg[4]\ : in STD_LOGIC_VECTOR ( 1 downto 0 );
...
\myReadData[8]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \rd_index_reg[4]\(0),
      I4 => Q(0),
      I5 => \myReadData[8]_i_4_n_0\,
      O => \^e\(0)
    );
\myReadData[8]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect_0 is
  ...
  attribute SOFT_HLUTNM of \FIFO_DATA[0][8]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \FIFO_DATA[10][8]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \FIFO_DATA[11][8]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \FIFO_DATA[12][8]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \FIFO_DATA[13][8]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \FIFO_DATA[14][8]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \FIFO_DATA[15][8]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \FIFO_DATA[1][8]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \FIFO_DATA[2][8]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \FIFO_DATA[3][8]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \FIFO_DATA[4][8]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \FIFO_DATA[5][8]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \FIFO_DATA[6][8]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \FIFO_DATA[7][8]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \FIFO_DATA[8][8]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \FIFO_DATA[9][8]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \wr_index[4]_i_1\ : label is "soft_lutpair8";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_FIFOTEST is
  ...
  signal \myReadData_reg[3]_i_4_n_0\ : STD_LOGIC;
  signal \myReadData_reg[3]_i_5_n_0\ : STD_LOGIC;
  ...
  signal \myReadData_reg[8]_i_6_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of fifo_is_full_reg_i_3 : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \myReadData[1]_i_2\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \myReadData[1]_i_5\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \myReadData[3]_i_6\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \rd_index[0]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \rd_index[1]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \rd_index[2]_i_1\ : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of \watermark[0]_INST_0\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \watermark[1]_INST_0\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \watermark[2]_INST_0\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \watermark[3]_INST_0_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \watermark[4]_INST_0_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \wr_index[1]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \wr_index[2]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \wr_index[3]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \wr_index[4]_i_3\ : label is "soft_lutpair12";
begin
...
\myReadData[0]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000C088"
    )
        port map (
      I0 => \FIFO_DATA_reg_n_0_[8][0]\,
      I1 => axi_aresetn,
      I2 => \FIFO_DATA_reg_n_0_[9][0]\,
...
\myReadData[0]_i_9\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000C088"
    )
        port map (
      I0 => \FIFO_DATA_reg_n_0_[0][0]\,
      I1 => axi_aresetn,
      I2 => \FIFO_DATA_reg_n_0_[1][0]\,
      I3 => \^rd_index_reg[4]_1\(0),
      I4 => \^rd_index_reg[4]_1\(1),
...
\myReadData[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \^rd_index_reg[4]_1\(3),
      I3 => \myReadData[1]_i_4_n_0\,
      I4 => \^rd_index_reg[4]_1\(2),
      I5 => \myReadData[1]_i_5_n_0\,
      O => FIFO_DATA(1)
    );
\myReadData[1]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFF1000"
    )
        port map (
...
\myReadData[1]_i_4\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \^rd_index_reg[4]_1\(1),
      I5 => \myReadData[1]_i_8_n_0\,
      O => \myReadData[1]_i_4_n_0\
    );
\myReadData[1]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAAEAAA"
    )
        port map (
      I0 => \myReadData[1]_i_9_n_0\,
      I1 => axi_aresetn,
      I2 => \FIFO_DATA_reg_n_0_[1][1]\,
      I3 => \^rd_index_reg[4]_1\(0),
      I4 => \^rd_index_reg[4]_1\(1),
...
\myReadData[1]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F8C8000038080000"
    )
        port map (
      I0 => \FIFO_DATA_reg_n_0_[13][1]\,
      I1 => \^rd_index_reg[4]_1\(0),
      I2 => \^rd_index_reg[4]_1\(1),
      I3 => \FIFO_DATA_reg_n_0_[14][1]\,
      I4 => axi_aresetn,
...
\myReadData[1]_i_9\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AC0F0000AC000000"
    )
        port map (
      I0 => \FIFO_DATA_reg_n_0_[3][1]\,
      I1 => \FIFO_DATA_reg_n_0_[2][1]\,
      I2 => \^rd_index_reg[4]_1\(0),
      I3 => \^rd_index_reg[4]_1\(1),
      I4 => axi_aresetn,
      I5 => \FIFO_DATA_reg_n_0_[0][1]\,
...
\myReadData[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \^rd_index_reg[4]_1\(3),
      I3 => \myReadData_reg[3]_i_4_n_0\,
      I4 => \^rd_index_reg[4]_1\(2),
      I5 => \myReadData_reg[3]_i_5_n_0\,
      O => FIFO_DATA(3)
    );
\myReadData[3]_i_10\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B080"
        ...
        port map (
      I0 => \FIFO_DATA_reg_n_0_[1][3]\,
      I1 => \^rd_index_reg[4]_1\(0),
      I2 => axi_aresetn,
      I3 => \FIFO_DATA_reg_n_0_[0][3]\,
      O => \myReadData[3]_i_10_n_0\
    );
\myReadData[3]_i_11\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B080"
    )
        port map (
...
\myReadData[3]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \^rd_index_reg[4]_1\(1),
      I5 => \myReadData[3]_i_6_n_0\,
      O => \myReadData[3]_i_2_n_0\
    );
\myReadData[3]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAAEAAA"
    )
        port map (
      I0 => \myReadData[3]_i_7_n_0\,
      I1 => axi_aresetn,
      I2 => \FIFO_DATA_reg_n_0_[9][3]\,
      I3 => \^rd_index_reg[4]_1\(0),
      I4 => \^rd_index_reg[4]_1\(1),
...
\myReadData[3]_i_7\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \FIFO_DATA_reg_n_0_[10][3]\,
      I2 => \^rd_index_reg[4]_1\(0),
      I3 => \^rd_index_reg[4]_1\(1),
      I4 => axi_aresetn,
      I5 => \FIFO_DATA_reg_n_0_[8][3]\,
...
\myReadData[4]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAAEAAA"
    )
        port map (
...
\myReadData[4]_i_6\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \FIFO_DATA_reg_n_0_[14][4]\,
      I2 => \^rd_index_reg[4]_1\(0),
      I3 => \^rd_index_reg[4]_1\(1),
      I4 => axi_aresetn,
      I5 => \FIFO_DATA_reg_n_0_[12][4]\,
      O => \myReadData[4]_i_6_n_0\
    );
\myReadData[4]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B080"
    )
        port map (
      I0 => \FIFO_DATA_reg_n_0_[9][4]\,
      I1 => \^rd_index_reg[4]_1\(0),
      I2 => axi_aresetn,
      I3 => \FIFO_DATA_reg_n_0_[8][4]\,
...
\myReadData[8]_i_13\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B080"
    )
        port map (
...
\myReadData[8]_i_14\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AC0F0000AC000000"
    )
        port map (
...
\myReadData[8]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
        ...
        port map (
      I0 => \myReadData_reg[8]_i_5_n_0\,
      I1 => \myReadData_reg[8]_i_6_n_0\,
      I2 => \^rd_index_reg[4]_1\(3),
      I3 => \myReadData[8]_i_7_n_0\,
      I4 => \^rd_index_reg[4]_1\(2),
...
\myReadData[8]_i_7\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \^rd_index_reg[4]_1\(1),
      I5 => \myReadData[8]_i_13_n_0\,
      O => \myReadData[8]_i_7_n_0\
    );
\myReadData[8]_i_8\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAAEAAA"
    )
        port map (
      I0 => \myReadData[8]_i_14_n_0\,
      I1 => axi_aresetn,
...
\myReadData_reg[3]_i_4\: unisim.vcomponents.MUXF7
     port map (
      I0 => \myReadData[3]_i_8_n_0\,
      I1 => \myReadData[3]_i_9_n_0\,
      O => \myReadData_reg[3]_i_4_n_0\,
      S => \^rd_index_reg[4]_1\(1)
    );
\myReadData_reg[3]_i_5\: unisim.vcomponents.MUXF7
     port map (
      I0 => \myReadData[3]_i_10_n_0\,
      I1 => \myReadData[3]_i_11_n_0\,
      O => \myReadData_reg[3]_i_5_n_0\,
      S => \^rd_index_reg[4]_1\(1)
    );
...
\myReadData_reg[8]_i_5\: unisim.vcomponents.MUXF7
     port map (
      ...
      I1 => \myReadData[8]_i_10_n_0\,
      O => \myReadData_reg[8]_i_5_n_0\,
      S => \^rd_index_reg[4]_1\(1)
    );
\myReadData_reg[8]_i_6\: unisim.vcomponents.MUXF7
     port map (
      I0 => \myReadData[8]_i_11_n_0\,
      I1 => \myReadData[8]_i_12_n_0\,
      O => \myReadData_reg[8]_i_6_n_0\,
      S => \^rd_index_reg[4]_1\(1)
    );
...
rd_edge: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect
     port map (
      ...
      \rd_index_reg[4]\(1 downto 0) => \^rd_index_reg[4]_1\(4 downto 3),
      \rd_index_reg[4]_0\ => \myReadData[8]_i_3_n_0\,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  attribute SOFT_HLUTNM of \officialBaudRate[31]_i_2\ : label is "soft_lutpair18";
