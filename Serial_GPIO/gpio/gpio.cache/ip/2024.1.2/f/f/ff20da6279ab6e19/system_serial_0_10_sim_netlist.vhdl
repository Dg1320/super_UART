...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect is
  port (
    \officialData_reg[0]\ : out STD_LOGIC;
    \officialData_reg[1]\ : out STD_LOGIC;
    \officialData_reg[2]\ : out STD_LOGIC;
    \officialData_reg[3]\ : out STD_LOGIC;
    \officialData_reg[4]\ : out STD_LOGIC;
    \officialData_reg[5]\ : out STD_LOGIC;
    \officialData_reg[6]\ : out STD_LOGIC;
    \officialData_reg[7]\ : out STD_LOGIC;
    \officialData_reg[8]\ : out STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detect is
  ...
  attribute SOFT_HLUTNM of \FIFO_DATA[0][8]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of in_delay_i_1 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of overflow_i_2 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \wr_index[4]_i_1\ : label is "soft_lutpair0";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_FIFOTEST is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FIFO_DATA[0][8]_i_3\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \wr_index[4]_i_4\ : label is "soft_lutpair3";
begin
...
\FIFO_DATA[0][8]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  attribute SOFT_HLUTNM of \raddr[3]_i_1\ : label is "soft_lutpair6";
begin
...
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      ...
      overflow => overflow,
      rd_data(8 downto 0) => rd_data(8 downto 0),
      wr_index(4 downto 0) => watermark(4 downto 0)
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
...
begin
  ...
  rd_index(1) <= \<const0>\;
  rd_index(0) <= \<const0>\;
  watermark(4 downto 0) <= \^wr_index\(4 downto 0);
